...
- `FlowBuilder/` - Sequential pipeline builder with group/single uploads, grouped source/destination presentation, output mapping, and preview selectors that keep batch context when switching source files
